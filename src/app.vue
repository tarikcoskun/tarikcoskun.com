    ...
    <header>
      <section>
        ...
        <aside class="links">
          ...
          <a href="mailto:me@tarikcoskun.xyz"
            class="button"
            target="_blank"
    ...
    <figure class="wrapper wrapper-hero">
      <section id="hero" xyz="fade left-4 duration-8 stagger-1">
        ...
        <aside class="accounts" xyz="fade down-2 ease-out-back duration-20 delay-8 stagger-1">
          <Animated><a href="mailto:me@tarikcoskun.xyz"
            class="button"
  ...
  section {
    ...
    aside.links {
      ...
      a {
        ...
        &.button { @include mobile { display: none } }
      }
    }
  }
}
...
figure.wrapper {
  ...
  &.wrapper-accent { background: var(--accent) }
  &.wrapper-bg { background: var(--about-bg) }
...
section {
  ...
  &#footer {
    ...
    span { color: var(--title-solid); font-size: 16px }
    p { font-size: 16px }
    a {
      border-bottom: 1px dashed transparent;
      color: var(--title-solid); font-size: 16px;
